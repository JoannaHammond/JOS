...
uint64_t usedMemory;
uint64_t largestFreeMemSegSize;
...
void PageFrameAllocator::ReadEFIMemoryMap(EFI_MEMORY_DESCRIPTOR* mMap, size_t mMapSize, size_t mMapDescSize){
    ...
    ReservePages(0, 0x100); // reserve between 0 and 0x100000, remember each page is 0x1000
...
uint64_t PageFrameAllocator::GetLargestFreeMemSegSize(){
    return largestFreeMemSegSize;
}